...
import { Bellicon, DateIconBlogDetailPage, Men, Timer, Topic } from "@/utils/icons/icons";
                ...
                <div className="p-5">
                    ...
                    <div className="flex flex-wrap justify-center gap-5">
                        {data.data.details.map((item) => (
                            ...
                            //                         </button>
                            //                     )} */}
                            //                 <button className="border-2 border-[#0B405D] border-solid w-full shadow  bg-[#CBD6DF] hover:bg-[rgb(255,200,29)] hover:text-black  focus:shadow-outline focus:outline-none text-[##0B405D]  py-1 px-2 rounded-3xl " type="submit">
                            //                     <div className="flex gap-2">
                            //                         <Bellicon />
                            //                         <div >
                            //                             Remind Me
                            ...
                            <div class="card">
                                ...
                                <button class="card-btn"><Link href="https://meet.easyhaionline.com/">Remind Me</Link></button>
                            </div>
                        ))}
                    </div>
                    {/* </div> */}
